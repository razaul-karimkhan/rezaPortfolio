    ...
    <div className="w-full lgl:w-1/2 flex flex-col gap-20">
      <div className="flex flex-col gap-5">
        ...
        <p className="text-base font-bodyFont leading-6 tracking-wide">
          An aimless life has no meaning. It rarely finds enthusiasm and energy.
          In fact, an aim is the sauce of life. It sustains the very spirit of
          existence. My aim is nothing extraordinary
        </p>
      </div>
