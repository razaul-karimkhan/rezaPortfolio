  ...
  return (
    <div className='w-full h-1/3 group flex'>
        ...
        rounded-lg p-4 lgl:px-10 flex flex-col justify-center gap-6 lgl:gap-10 shadow-shadowOne' >
           ...
           <div>
            <h3 className='text-xl md:text-2xl font-semibold group-hover:text-white
            duration-300'>{title}</h3>
            <p className='text-sm mt-2 text-gray-400 group-hover:text-white
            duration-300'>{subTitle}</p>
            </div>

            <div className='px-4 py-2 text-designColor bg-black bg-opacity-25 rounded-lg
           ...
           <div>
           <p className='text-sm md:text-base font-medium text-gray-400 group-hover:text-gray-300'>{des}</p>
           </div>
        </div>
