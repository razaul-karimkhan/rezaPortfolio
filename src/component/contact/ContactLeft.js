...
const ContactLeft = () => {
  return (
    <div className='w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 lgl:p-8
       ...
       <div className='flex flex-col gap-4'>
          ...
          <p className='text-lg font-normal text-gray-400'>MERN STACK DEVELOPER</p>
           <p className='text-base text-gray-400 tracking-wide'>
              My name is razaul karim i am a website developer.
              My dream to be a successful freelancer.
           </p>
           ...
           <p className='text-base text-gray-400 flex items-center gap-2'>
              Email: <span className='text-lightText'>razaulkarim19725@gmail.com</span>
